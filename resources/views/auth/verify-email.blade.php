{{-- <x-guest-layout>
    ...
    <div class="app-brand justify-content-center">
        <a href="index.html" class="app-brand-link gap-2">
            ...
            <span class="app-brand-text demo text-body fw-bolder">Front Dashboard</span>
        </a>
    </div>
    <!-- /Logo -->
...
<head>
    ...
    <title>Verify Email | Grab A Car</title>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('front-assets') }}/vendor/css/core.css"
    ...
    <div class="container-xxl">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="index.html" class="app-brand-link gap-2 mb-4">
                            <span class="app-brand-logo demo">
                        ...
                        <p class="mb-4">Please verify your email address by clicking on the link we just sent to your
                            email.</p>

                        <form id="emailVerificationForm" class="mb-3" action="{{ route('verification.send') }}"
                            method="POST">
                            @csrf
